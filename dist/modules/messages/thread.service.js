...
export async function requireParty(conversationId, userId) {
...
function readField(conversation, userId) {
    return conversation.clientId === userId ? 'clientLastReadAt' : 'freelancerLastReadAt';
}
export async function markRead(conversationId, userId, conversation) {
...
export async function listMessages(conversationId, userId, search) {
    ...
    if (!search)
        await markRead(conversationId, userId, conversation);
